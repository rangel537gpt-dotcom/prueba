 ...
 * @author user
 */
public class dAuditorIndependiente extends javax.swing.JDialog {
...
//    private ClienteEstudioContable clienteEstudioContable;
     ...
     */
    public dAuditorIndependiente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("BUSCAR AUDITOR INDEPENDIENTE");
...
//            btnGuardar.setEnabled(false);
            ...
            ClienteAuditorIndependiente cliente = (ClienteAuditorIndependiente) model.getValueAt(fila, 0);
...
//                ((frmSociedad) this.frm).agregarMiembro(cliente);
    ...
    private void buscarContador() {
        ...
        List<ClienteAuditorIndependiente> l = c.buscarAuditorIndependiente(txtBusqueda.getText(), tipoBusqueda);
        ...
        int contador = 0;
        for (ClienteAuditorIndependiente cli : l) {
            ...
            tContador.setValueAt(cli.getCliente().getCcodigoCole(), contador, 2);
            tContador.setValueAt(cli.getCliente().getPnroDocumento(), contador, 3);
            tContador.setValueAt(cli.getCliente().getPapePat(), contador, 4);
            tContador.setValueAt(cli.getCliente().getPapeMat(), contador, 5);
            tContador.setValueAt(cli.getCliente().getPnombre(), contador, 6);
            tContador.setValueAt(cli.getCliente().getPfechaNac(), contador, 7);
            tContador.setValueAt(cli.getCliente().getPsexo(), contador, 8);
            contador++;
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dAuditorIndependiente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dAuditorIndependiente dialog = new dAuditorIndependiente(new javax.swing.JFrame(), true);
