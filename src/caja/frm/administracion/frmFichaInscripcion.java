 ...
 * @author juan carlos
 */
public class frmFichaInscripcion extends javax.swing.JInternalFrame {
...
//        columna.setPreferredWidth(15);
        ...
        columna = tContador.getColumn("FICHA");
...
//        }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("FICHA DE PRE-INSCRIPCION");
        ...
        tContador.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NRO", "DNI", "APELLIDO PATERNO", "APELLIDO MATERNO", "NOMBRES", "FICHA"
            }
        ) {
...
//        btnFechaA.setEnabled(false);
        ...
        if (cbFiltro.getSelectedItem() == "POR APELLIDOS") {
            ...
            filtro = " AND f.dni like '" + txtBusqueda.getText().trim() + "'";
        } else if (cbFiltro.getSelectedItem() == "POR NOMBRES") {
            filtro = " AND concat(concat(concat(concat(f.apePat, ' '),f.apeMat),' '),f.nombre) like '%" + txtBusqueda.getText().trim() + "%'";
        ...
        List<FichaDatos> l = c.BuscarFichaInscripcion(filtro);
        ...
        for (FichaDatos cli : l) {
            ...
            tContador.setValueAt(cli.getDni(), contador, 2);
            tContador.setValueAt(cli.getApePat(), contador, 3);
            tContador.setValueAt(cli.getApeMat(), contador, 4);
            tContador.setValueAt(cli.getNombre(), contador, 5);
            tContador.setValueAt(cli.getNro(), contador, 6);
