 ...
 * @author user
 */
public class dGeneracionComprobanteBbva extends javax.swing.JDialog {
     ...
     */
    public dGeneracionComprobanteBbva(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Date ahora = new Date();
...
//        Object[] losValores = new Object[lDocumentos.size()];
    ...
    public void CargarDatos(Object f, Bbva b, BbvaRetorno r, int tc) {
        this.frm = f;
        this.bbva = b;
        this.bbvaRetorno = r;
        this.tipoCarga = tc;
...
//            }
    ...
    private void Generar() {
        try {
            ...
            cBO.GenerarComprobantePagoBbva(fecha, ((TipoDocPago) cbTipoDocumento.getSelectedItem()).getIdTipoDocPago(), cbSerie.getSelectedItem().toString(), this.bbvaRetorno.getId());
            if (this.tipoCarga == 1) {
                ((frmBBVARetorno) this.frm).CargarDatos(this.bbva);
            }
            if (this.tipoCarga == 2) {
                ((frmBBVARetornoSubir) this.frm).CargarDatos(this.bbva);
            }
            this.dispose();
        } catch (ParseException ex) {
            Logger.getLogger(dGeneracionComprobanteBbva.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dGeneracionComprobanteBbva.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dGeneracionComprobanteBbva dialog = new dGeneracionComprobanteBbva(new javax.swing.JFrame(), true);
