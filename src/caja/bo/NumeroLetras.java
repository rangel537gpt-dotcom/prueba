 ...
 * @author Camilo Nova
 */
public abstract class NumeroLetras {
     ...
     */
    public static String convertirNumerosALetras(String number, String tipoMoneda)
            throws NumberFormatException {
        return convertirNumerosALetras(Double.parseDouble(number), tipoMoneda);
    }
     ...
     */
    public static String convertirNumerosALetras(double doubleNumber, String tipoMoneda)
            throws NumberFormatException {

        StringBuilder converted = new StringBuilder();
        String moneda = "";
        if (tipoMoneda.equals("D")) {
            moneda = "DOLARES";
        } else {
            moneda = "SOLES";
        }
        ...
        if (centavos == 1) {
            converted.append(" CON UN 01/100 " + moneda);
        } else if (centavos > 1) {
            converted.append(" CON " + String.valueOf(centavos) + "/100 " + moneda);
        } else if (centavos == 0) {
            converted.append(" CON 00/100 " + moneda);
        }
